...
<body>
  ...
  .car:hover .stroke {
    ...
    <div class="contain">
      <div class="car">
        <div class="bar">
          <img src="ass/img/ba.png" style="max-width: 100%;" class="" alt="">
        </div>
        <div class="bt">
          <a href=""><button class="btn btn-danger">Voir+</button></a>
        </div>
      </div>
      <div class="car">
        
        <div class="bar">
          <img src="ass/img/jw.png" style="max-width: 100%;" class="" alt="">
        </div>
         <div class="bt">
          <a href=""><button class="btn btn-danger">Voir+</button></a>
        </div>
      ...
      <div class="car">
        ...
        <div class="bar">
          <img src="ass/img/dn.png" style="max-width: 100%;" class="" alt="">
        </div>
         <div class="bt">
          <a href=""><button class="btn btn-danger">Voir+</button></a>
        </div>
      ...
      <div class="car">
        ...
        <div class="bar">
          <img src="ass/img/ke.png" style="max-width: 100%;" class="" alt="">
        </div>
         <div class="bt">
          <a href=""><button class="btn btn-danger">Voir+</button></a>
        </div>
          ...
          <div class="row">
             @foreach ($film as $film)
               <div class="card col-xxl-3 col-md-4" style="">
                   <img src="{{asset('Uploads/film/' . $film->image) }}" class="" alt="..." style="max-width: 100%;">
                   <div class="card-body">
