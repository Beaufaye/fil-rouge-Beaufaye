...
<html lang="en">
  <head>
    ...
    <link href="card/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="card/css/fontawesome.min.css" rel="stylesheet" type="text/css" />
    <link href="card/css/owl.carousel.min.css" rel="stylesheet" type="text/css" />
...
/* Banner */
  ...
  <main id="main" class="">
    ...
    <!-- ======= Services Section ======= -->
    <section id="services" class="services bg-light mt-5">
      <div class="container">

        <div class="section-title">
          <span>PROCHAINES SEANCES</span>
          ...
          <div class="row">
             @foreach ($film as $film)
               <div class="card col-xxl-3 col-md-4" style="">
                   <img src="{{asset('Uploads/photos/' . $film->image) }}" class="" alt="..." style="max-width: 100%;">
                   <div class="card-body">
                     <h2 class="card-title text-center text-primary">{{ $film->nom}}</h2>
                   </div>
                   <h4 class="text-center">{{ $film->jour}} | {{ $film->heure}}</h4>
                 </div>
             @endforeach
           </div>
         </div>  --}}
         ...
         <!-- Boxes -->
              ...
              @foreach ($film as $film)
							<div class="box bg-secondary">
								<a href="{{ $film->lien}}" class="image fit"><img src="{{asset('Uploads/photos/' . $film->image) }}" alt="" width="600" height="338"></a>
								<div class="inner">
                  <p class="text-center">{{ $film->type}}</p>
									<h3 class="text-light">{{ $film->jour}} | {{ $film->heure}}</h3>
									<p>{{ $film->description}}</p>
									<a href="{{ $film->lien}}" class="button style2 fit bg-primary" data-poptrox="youtube,800x400">Voir la Bande-annonce</a>
								</div>
							</div>
              @endforeach
						</div>
  ...
  <script src="as/js/jquery.scrolly.min.js"></script>
  <script src="as/js/jquery.poptrox.min.js"></script>
  <script src="as/js/skel.min.js"></script>
  <script src="as/js/util.js"></script>
  <script src="as/js/main.js"></script>

  <script src="card/js/jquery-3.4.1.min.js"></script>
  <script src="card/js/bootstrap.min.js"></script>
  <script src="card/js/owl.carousel.min.js"></script>
  <script>
